...
<body class="text-white bg-slate-800 min-h-screen">
    ...
    <section class="container m-auto pt-20">
        <h1 class="text-center text-2xl font-bold">Edit User Information</h1>
        ...
        <form action="" method="post" class="flex flex-col justify-center w-[620px] m-auto mt-16">
            <div class="flex gap-5 w">
                <div class="flex flex-col">
                    ...
                    <input type="text" name="first_name" value="<?php echo $row['first_name'] ?>" class="rounded-md h-8 w-[300px] border-gray-300 mt-1 capitalize text-slate-700" required>
                </div>
                <div class="flex flex-col">
                    <label for="last_name">Last Name</label>
                    <input type="text" name="last_name" value="<?php echo $row['last_name'] ?>" class="rounded-md h-8 w-[300px] border-gray-300 mt-1 capitalize text-slate-700" required>
                </div>
            </div>
            <div class="flex flex-col w-full mt-4">
                <label for="email">Email</label>
                <input type="email" name="email" value="<?php echo $row['email'] ?>" class="rounded-md h-8 w-full border-gray-300 mt-1 text-slate-700" required>
            </div>
            <div class="mt-4">
                <label>Gender :</label> &nbsp;
            ...
            <div class="button mt-4">
                <button type="submit" name="submit" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Update</button>
